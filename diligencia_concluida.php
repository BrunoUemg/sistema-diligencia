...
$result_consultaDiligencia = "SELECT *  FROM diligencia D INNER JOIN usuario U ON D.idUsuario = U.idUsuario where D.situacao = 1   ";
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
            <center><h3>Diligências concluídas</h3></center>
                  ...
                  <tbody>
                    ...
                    while ($rows_diligencia = mysqli_fetch_assoc($resultado_consultaDiligencia)) {
                      ...
                      <td><?php echo $rows_diligencia['idDiligencia']; ?></td>
                        ...
                        <?php  echo "<a class='btn btn-default' title='Imprimir histórico' href='imprimir_historico_diligencia.php?idDiligencia=" . $rows_diligencia['idDiligencia'] . "'>" ?><i class="fa fa-file-archive"></i><?php echo "</a>"; ?> 
